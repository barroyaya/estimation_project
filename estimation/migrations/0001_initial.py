    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unite', models.CharField(choices=[('u', 'Unité'), ('ml', 'Mètre linéaire'), ('m2', 'm²'), ('m3', 'm³'), ('kg', 'Kilogramme'), ('h', 'Heure'), ('j', 'Jour'), ('ens', 'Ensemble'), ('ff', 'Forfait'), ('autre', 'Autre (saisir ci-dessous)')], default='u', max_length=10)),
                ('unite_personnalisee', models.CharField(blank=True, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unite', models.CharField(choices=[('u', 'Unité'), ('ml', 'Mètre linéaire'), ('m2', 'm²'), ('m3', 'm³'), ('kg', 'Kilogramme'), ('h', 'Heure'), ('j', 'Jour'), ('ens', 'Ensemble'), ('ff', 'Forfait'), ('autre', 'Autre (saisir ci-dessous)')], default='u', max_length=10)),
                ('unite_personnalisee', models.CharField(blank=True, help_text="Saisissez l'unité personnalisée si 'Autre' est sélectionné", max_length=20)),
                ('actif', models.BooleanField(default=True)),
                ('categorie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estimation.categorie')),
                ('discipline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='estimation.discipline')),
            ],
